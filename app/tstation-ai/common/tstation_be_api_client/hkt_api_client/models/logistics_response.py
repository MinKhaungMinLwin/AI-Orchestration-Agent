...
class LogisticsResponse:
    ...
    Attributes:
        ...
        rsv_install_date (None | str | Unset): 예약판매 장착 가능 날짜 (rsv_sale_yn=Y일 때, 워킹데이 14일 후). 형식: YYYY-MM-DD
    """

    logistics_qty: int | None | Unset = UNSET
    rsv_sale_yn: None | str | Unset = UNSET
    rsv_install_date: None | str | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        rsv_install_date: None | str | Unset
        if isinstance(self.rsv_install_date, Unset):
            rsv_install_date = UNSET
        else:
            rsv_install_date = self.rsv_install_date
        ...
        if rsv_install_date is not UNSET:
            field_dict["rsv_install_date"] = rsv_install_date
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_rsv_install_date(data: object) -> None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        rsv_install_date = _parse_rsv_install_date(d.pop("rsv_install_date", UNSET))

        logistics_response = cls(
            logistics_qty=logistics_qty,
            rsv_sale_yn=rsv_sale_yn,
            rsv_install_date=rsv_install_date,
        )
