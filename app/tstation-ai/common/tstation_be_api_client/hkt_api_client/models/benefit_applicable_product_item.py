...
T = TypeVar("T", bound="BenefitApplicableProductItem")


@_attrs_define
class BenefitApplicableProductItem:
    """
    Attributes:
        ptrn_cd (None | str | Unset): 패턴 코드
        goods_nm (None | str | Unset): 대표 상품명
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        benefit_applicable_product_item = cls(
            ptrn_cd=ptrn_cd,
            goods_nm=goods_nm,
        )

        benefit_applicable_product_item.additional_properties = d
        return benefit_applicable_product_item
