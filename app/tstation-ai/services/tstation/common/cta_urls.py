...
_CTA_PATH_PAIRS: Final[tuple[_CTAPathPair, ...]] = (
    ...
    _path_pair("WARRANTY_EASE_DETAIL", "/warranty/detail?type=ease"),
    _path_pair("SAFE_SERVICE_SIGNUP", "/safeservice/ts/lendingForm"),
...
class CTAUrls:
    ...
    WARRANTY_EASE_DETAIL: Final[str] = f"{_PC}/warranty/detail?type=ease"
    SAFE_SERVICE_SIGNUP: Final[str] = f"{_PC}/safeservice/ts/lendingForm"
...
_SENTINEL_MAP: Mapping[str, str] = {
    ...
    "__URL_WARRANTY_EASE_DETAIL__": CTAUrls.WARRANTY_EASE_DETAIL,
    "__URL_SAFE_SERVICE_SIGNUP__": CTAUrls.SAFE_SERVICE_SIGNUP,
