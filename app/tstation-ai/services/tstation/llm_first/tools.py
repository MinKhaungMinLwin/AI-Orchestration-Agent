...
TOOL_REGISTRY: dict[str, ToolSpec] = {
    ...
    "get_benefit_event_deal_list_tool": ToolSpec("get_benefit_event_deal_list_tool", frozenset({AgentFlow.PRODUCT_DESCRIPTION}), lambda: _discovery_tool("get_benefit_event_deal_list_tool")),
    "get_event_applicable_products_tool": ToolSpec("get_event_applicable_products_tool", frozenset({AgentFlow.PRODUCT_DESCRIPTION}), lambda: _discovery_tool("get_event_applicable_products_tool"), required_args=frozenset({"evt_no_list"})),
    "search_benefit_applicable_products_tool": ToolSpec("search_benefit_applicable_products_tool", frozenset({AgentFlow.PRODUCT_DESCRIPTION}), lambda: _discovery_tool("search_benefit_applicable_products_tool"), required_args=frozenset({"query"})),
    "get_my_cars_tool": ToolSpec("get_my_cars_tool", frozenset({AgentFlow.PRODUCT_COMPATIBILITY}), lambda: _discovery_tool("get_my_cars_tool")),
    "get_user_vehicles_tool": ToolSpec("get_user_vehicles_tool", frozenset({AgentFlow.PRODUCT_COMPATIBILITY}), lambda: _discovery_tool("get_user_vehicles_tool"), required_args=frozenset({"car_no", "owner_nm"})),
    "search_car_model_tool": ToolSpec("search_car_model_tool", frozenset({AgentFlow.PRODUCT_COMPATIBILITY}), lambda: _discovery_tool("search_car_model_tool"), required_args=frozenset({"keyword"})),
    "search_car_model_groups_tool": ToolSpec("search_car_model_groups_tool", frozenset({AgentFlow.PRODUCT_COMPATIBILITY}), lambda: _discovery_tool("search_car_model_groups_tool"), required_args=frozenset({"keyword"})),
