    ...
    async def plan(
        ...
        *,
        ...
        prompt = (
            ...
            "region, store_name, store_lookup, ord_qty, goods_no, shop_id, tire_size, schedule date/time, "
            "car_no, owner_nm, car_model, store_attribute in known_inputs when the user or state provides them. "
