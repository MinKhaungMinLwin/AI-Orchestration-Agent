...
- ⚠️ 본 룰은 워런티/안심서비스/얼라인먼트/알림/측정이력/픽업서비스/도서산간·제주 배송비/점검·유지보수/온라인 전용 상품/리뷰 작성 등 위에 명시된 **CTA 강제 룰이 적용되는 답변에는 적용하지 마라** — 그 답변들은 명시된 CTA chip 이 첫 번째 자리를 반드시 차지하며 본 룰보다 우선한다.
