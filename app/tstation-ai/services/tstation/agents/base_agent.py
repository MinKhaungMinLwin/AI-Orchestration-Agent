...
TOOL_DISPLAY_NAMES: dict[str, str] = {
    ...
    "get_best_selling_products_tool": "베스트셀러 조회중",
    "get_newest_products_tool": "상품 조회중",
    ...
    "get_coupon_applicable_products_tool": "쿠폰 조회중",
    ...
    "get_store_schedule_tool": "스케줄 조회중",
    ...
    "get_my_relief_services_tool": "안심서비스 내역 조회 중...",
    "get_my_warranties_tool": "내 워런티 조회 중...",
    "get_maintenance_dday_tool": "정비내역 조회중",
